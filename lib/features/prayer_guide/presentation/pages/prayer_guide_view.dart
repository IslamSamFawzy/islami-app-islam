            ...
            Expanded(
              child: BlocBuilder<PrayerGuideCubit, PrayerGuideState>(
                ...
                builder: (context, state) {
                  switch (state.status) {
                    case PrayerGuideStatus.initial:
                    case PrayerGuideStatus.loading:
                      return const Center(
                        child: CircularProgressIndicator(
                          color: AppColors.primaryColor,
                        ),
                      );
                    case PrayerGuideStatus.failure:
                      return Center(
                        child: Padding(
                    ...
                    case PrayerGuideStatus.success:
...
class _PageControls extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PrayerGuideCubit, PrayerGuideState>(
      builder: (context, state) {
        if (state.status != PrayerGuideStatus.success) {
